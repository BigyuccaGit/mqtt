...
mqtt_receive_topic2 = "bigyucca/feeds/my-button-feed-2"  # The MQTT topic for your Adafruit IO Feed
...
mqtt_client.publish(mqtt_receive_topic, "OFF2")

# Once connected, subscribe to the MQTT topic
mqtt_client.subscribe(mqtt_receive_topic)
mqtt_client.subscribe(mqtt_receive_topic2)
...
try:
    while True:
        ...
        print(f'Waiting for messages on {mqtt_receive_topic[-2]}')
